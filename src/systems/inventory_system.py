...
class InventorySystem:
    ...
    def __init__(self, max_slots: int = 36, quest_system=None):
    ...
    def _initialize_item_database(self):
        """Initialize all available items"""
        items = [
            # Resources
            ("wood", "Wood", "Basic building material", ItemType.RESOURCE, ItemRarity.COMMON, "🪵", 2, 999),
            ("stone", "Stone", "Common mineral for building", ItemType.RESOURCE, ItemRarity.COMMON, "🪨", 2, 999),
            ("clay", "Clay", "Malleable earth material", ItemType.RESOURCE, ItemRarity.COMMON, "🧱", 3, 999),
            ("fiber", "Fiber", "Plant material for crafting", ItemType.RESOURCE, ItemRarity.COMMON, "🌾", 1, 999),
            
            # Seeds
            ("parsnip_seeds", "Parsnip Seeds", "Takes 4 days to mature", ItemType.SEED, ItemRarity.COMMON, "🌱", 20, 999),
            ("cauliflower_seeds", "Cauliflower Seeds", "Takes 12 days to mature", ItemType.SEED, ItemRarity.COMMON, "🌱", 80, 999),
            ("potato_seeds", "Potato Seeds", "Takes 6 days to mature", ItemType.SEED, ItemRarity.COMMON, "🌱", 50, 999),
            ("tomato_seeds", "Tomato Seeds", "Takes 11 days to mature", ItemType.SEED, ItemRarity.UNCOMMON, "🌱", 50, 999),
            
            # Crops
            ("parsnip", "Parsnip", "A basic root vegetable", ItemType.CROP, ItemRarity.COMMON, "🥕", 35, 999),
            ("cauliflower", "Cauliflower", "A valuable vegetable", ItemType.CROP, ItemRarity.COMMON, "🥬", 175, 999),
            ("potato", "Potato", "A common and filling tuber", ItemType.CROP, ItemRarity.COMMON, "🥔", 80, 999),
            ("tomato", "Tomato", "A juicy red fruit", ItemType.CROP, ItemRarity.UNCOMMON, "🍅", 60, 999),
            ...
            # Tools
            ("basic_axe", "Basic Axe", "Chops wood efficiently", ItemType.TOOL, ItemRarity.COMMON, "🪓", 200, 1),
            ("basic_pickaxe", "Basic Pickaxe", "Breaks rocks and mines ore", ItemType.TOOL, ItemRarity.COMMON, "⛏️", 200, 1),
            ("basic_hoe", "Basic Hoe", "Tills soil for planting", ItemType.TOOL, ItemRarity.COMMON, "🪓", 150, 1),
            ("basic_watering_can", "Basic Watering Can", "Waters crops", ItemType.TOOL, ItemRarity.COMMON, "🪣", 150, 1),
            ("fishing_rod", "Fishing Rod", "Catches fish in water", ItemType.TOOL, ItemRarity.COMMON, "🎣", 300, 1),
        ...
        for item_id, name, desc, item_type, rarity, icon, value, max_stack in items:
